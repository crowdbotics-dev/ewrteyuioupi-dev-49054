...
## Project Structure
    ...
    ├── ewrteyuioupi_dev_49054  # Django project configurations
...
1. Clone this repo and `cd ewrteyuioupi_dev_49054`
...
2. Clone this repo and `cd ewrteyuioupi_dev_49054`
